  ...
  <footer class="footer glass">
    <div class="footer-grid">
      ...
      <div class="social">
        <a href="<?= htmlspecialchars($SITE["links"]["youtube"]) ?>" target="_blank" aria-label="YouTube" class="icon-link" rel="noopener">
          <!-- YouTube SVG -->
          <svg viewBox="0 0 24 24" width="22" height="22" aria-hidden="true"><path d="M23.5 6.2s-.2-1.7-.9-2.4c-.9-.9-1.9-.9-2.4-1C17.6 2.5 12 2.5 12 2.5h0s-5.6 0-8.2.3c-.5.1-1.5.1-2.4 1C.7 4.5.5 6.2.5 6.2S.2 8.2.2 10.1v1.8c0 1.9.3 3.9.3 3.9s.2 1.7.9 2.4c.9.9 2.1.9 2.7 1 2 .2 8 .3 8 .3s5.6 0 8.2-.3c.5-.1 1.5-.1 2.4-1 .7-.7.9-2.4.9-2.4s.3-2 .3-3.9v-1.8c0-1.9-.3-3.9-.3-3.9zM9.8 14.5V7.8l6.2 3.3-6.2 3.4z" fill="currentColor"/></svg>
        </a>
